...
class LeapHandGrasp(LeapHandRot):
    ...
    def compute_reward(self, actions):
        def list_intersect(li, hash_num):
            ...
            obj_id = 21
            query_list = [obj_id * hash_num + 4, obj_id * hash_num + 8, obj_id * hash_num + 12, obj_id * hash_num + 16,obj_id * hash_num + 20]
        ...
        finger_pos = self.rigid_body_states[:, [4, 8, 12, 16, 20], :3]
