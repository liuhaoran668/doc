...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    def build_runner(algo_observer):
        ...
        model_builder.register_model('continuous_amp', lambda network, **kwargs : amp_models.ModelAMPContinuous(network))#这个是任务模型，将下面的网络进行利用
        model_builder.register_network('amp', lambda **kwargs : amp_network_builder.AMPBuilder())###注册网络结构，网络的参数等，网络的层数，节点和连接方式
    ...
    runner.reset()
    # print('-----------------------------------')
    # print(runner.algo_factory._builders.keys())
    # print(runner.player_factory._builders.keys())
