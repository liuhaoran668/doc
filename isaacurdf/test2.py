...
class UrdfJointViewer(QMainWindow):
    ...
    def setup_ui(self):
        ...
        #left_layout.addWidget(self.joints_group)
        
        # Right panel - Simulation status
        right_panel = QWidget()
        ...
        # Additional simulation controls can be added here
        right_layout.addWidget(sim_group)
        
        # Spacer to push everything to the top
        right_layout.addStretch()
        
        # Set the splitter's initial position (30% left, 70% right)
